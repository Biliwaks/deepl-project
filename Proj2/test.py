...
def main():
    ...
    model, results_list = train_and_evaluate(model, train, train_one_hot_target, test, test_one_hot_target, 25, 1e-2, 100)
    ...
    print("Train accuracy: {}, Test accuracy: {}".format(results_list[-1]["train_accuracy"], results_list[-1]["test_accuracy"]))
